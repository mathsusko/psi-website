...
export default function ClientCarousel() {
    return (_jsx("div", { className: "w-full py-8", children: _jsx(Swiper, { modules: [Autoplay], spaceBetween: 40, loop: true, freeMode: true, allowTouchMove: false, speed: 4000, autoplay: {
                delay: 0,
            ...
            }, className: "w-full", children: logos.map((src, index) => (_jsx(SwiperSlide, { className: "flex items-center justify-center", children: _jsx("img", { src: src, alt: `Cliente ${index}`, className: "h-32 w-auto grayscale transition duration-300 hover:grayscale-0" }) }, index))) }) }));
}
